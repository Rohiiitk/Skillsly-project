...
const IMAGES = {
  ...
  blueBlob: '/HeroBlue.png',  
};

const SkillSlyHeroPage = () => {
  return (
    <div className="min-h-screen bg-black text-white p-4 overflow-hidden relative">
      ...
      <main className="relative flex flex-col lg:flex-row items-center justify-between pt-10 px-6 md:px-12 min-h-[calc(100vh-80px)]"> {/* Adjusted min-height for content */}
        ...
        <div className="max-w-xl lg:w-1/2 mb-12 lg:mb-0 relative z-20">
          ...
          <div className="absolute top-[20%] left-[80%] md:left-[60%] lg:left-[calc(100%-80px)] transform -translate-y-1/2 z-10 w-24 h-24">
            ...
            />
            {/* The dotted path effect - needs fine-tuning for exact match */}
            <div className="absolute top-1/2 left-0 w-24 h-1 border-t-2 border-dashed border-gray-500 transform -translate-y-1/2 -translate-x-[90%] -rotate-6"></div>
            <div className="absolute top-1/2 left-0 w-24 h-1 border-t-2 border-dashed border-gray-500 transform -translate-y-1/2 -translate-x-[180%] -rotate-12"></div>
        ...
        <div className="relative lg:w-1/2 flex justify-center lg:justify-end min-h-[400px] lg:min-h-[600px] mt-10 lg:mt-0">
          ...
          <img
            ...
            style={{ 
              transform: 'translateX(20%) translateY(-20%)', // Adjust position
          ...
          <img
            ...
            className="absolute bottom-0 right-0 w-full lg:w-[600px] h-auto object-cover z-0"
            style={{ 
          ...
          <div className="relative z-10 w-full max-w-lg h-full flex justify-center items-end">
